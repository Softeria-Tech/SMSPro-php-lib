...
namespace Smspro\Test\TestCase\Http;
...
class HttpClientTest extends TestCase
{
    ...
    {
        return [
            ['https://sms.softeriatech.com/api/sms.json', ['api_key' => '3i3i', 'api_secret' => '3ueuu4'], 0],
            ['https://sms.softeriatech.com/api/sms.xml', ['api_key' => '3ifff3i', 'api_secret' => '3ueuu4'], 10],
        ];
    }
    ...
    {
        $this->response->expects($this->exactly(1))->method('getStatusCode')->will($this->returnValue(200));

        $this->oClient->expects($this->once())->method('sendRequest')->willReturn($this->response);
        $this->response->expects($this->any())->method('getJson')->willReturn(['data' => 'hello']);
    ...
    public function testPerformRequestFailure3(string $endpoint, array $hAuth, int $timeout): void
    {
        ...
        if (!defined('WP_SMSPRO_SMS_VERSION')) {
            define('WP_SMSPRO_SMS_VERSION', 1);
        }
    ...
    {
        return [
            ['https://sms.softeriatech.com/api', ['api_key' => '3i3i', 'api_secret' => '3ueuu4'], -10],
            ['https://sms.softeriatech.com/api', ['api_key' => '3ifff3i', 'api_secret' => '3ueuu4'], -1],
        ];
    }
    ...
    {
        return [
            ['https://sms.softeriatech.com/api', ['api_key' => '3i3i', 'api_secret' => '3ueuu4']],
            ['https://sms.softeriatech.com/api', ['api_key' => '3ifff3i', 'api_secret' => '3ueuu4']],
        ];
    }
}
