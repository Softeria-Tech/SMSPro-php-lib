...
use Smspro\Sms\Console\BulkMessageCommand;
use Smspro\Sms\Console\BulkMessageCommandHandler;
use Smspro\Sms\Console\Runner;
 ...
 *
 * @covers \Smspro\Sms\Console\Runner
 */
class RunnerTest extends TestCase
{
    ...
    /** @covers \Smspro\Sms\Console\Runner::run */
    ...
    public function testSendBulkMessageAndIterateGenerator(CallbackDto|array $callback): void
    {
        ...
        $messageResponse = new \Smspro\Sms\Response\Message($clientResponse);
