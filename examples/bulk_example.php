...
$oMessage = Message::create()->setCredential(new \Smspro\Sms\Entity\Credential('YOUR_API_KEY', 'YOUR_API_SECRET'));
...
$hCallback = [
    ...
    'driver' => [\Smspro\Sms\Database\MySQL::class, 'getInstance'],
    'bulk_chunk' => 1,
    'db_config' => [
        [
            'db_name' => 'test',
