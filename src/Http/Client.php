...
use Smspro\Http\Curl\Domain\Entity\Configuration;
use Smspro\Http\Curl\Infrastructure\Client as SmsproClient;
use Smspro\Http\Curl\Infrastructure\Request;
...
class Client
{
    ...
    private function applyRequest(array $headers, array $data, string $type, ?ClientInterface $client = null): Response
    {
        try {
            ...
            $client = $client ?? new SmsproClient($this->clientConfiguration);
